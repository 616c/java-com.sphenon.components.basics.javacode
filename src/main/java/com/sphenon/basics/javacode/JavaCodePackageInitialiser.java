...
public class JavaCodePackageInitialiser {
    ...
    static public void initialise (CallContext context) {
        ...
        if (initialised == false) {
            ...
            Configuration.loadDefaultProperties(context, com.sphenon.basics.javacode.JavaCodePackageInitialiser.class);
        }
    }
    ...
    static public Configuration getConfiguration (CallContext context) {
        if (config == null) {
            config = Configuration.create(RootContext.getInitialisationContext(), "com.sphenon.basics.javacode");
        }
        return config;
    }
}
